		...
		\section{Objectifs}
			\subsection{GenDbg}
				\subsubsection{Présentation}
					...
					\paragraph*{}
						Les modules obligatoires au fonctionnement de GenDbg sont le \gen{Stub}, le \gen{Framework}, le \gen{Module ASM} (module de désassemblage) et le \gen{\gls{GUI}}\footnote{interface graphique}. Historiquement seul un \gen{\gls{GUI}} en ``mode texte'' était disponible mais une seconde interface, graphique cette fois, et réalisée avec Qt fut développé plus tard.
					\begin{figure}[H]
						\centering
