...
DOCUMENTS_NAMES=RAPPORT_A17_INFO_ST40_PINARD_MAXIME PRESENTATION_DGA SOUTENANCE_UTBM
...
PACKAGES_REQUIRED[SOUTENANCE_UTBM]=amsmath amssymb array beamercolorthemeutbm beamerinnerthemeutbm beamerouterthemeutbm beamerthemeutbm caption float fontenc hyperref import listings lmodern mathrsfs multirow pgf pgf-umlsd pgfgantt standalone tabularx tikz translator xcolor packages/MagicListings packages/StandardLibraryCDefinition
