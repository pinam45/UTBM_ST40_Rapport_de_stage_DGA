...
\newacronym{FCCR}{FCCR}{Floating point condition codes register}
\newacronym{FCC}{FCC}{Floating point condition codes}
...
\newacronym{IDB}{IDB}{IDA database}
...
\newacronym{Windows PE}{Windows PE}{Windows preinstallation environment}
