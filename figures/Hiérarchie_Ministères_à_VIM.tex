...
\begin{document}
	...
	\begin{tikzpicture}[x=1pt,y=1pt]
		...
		\node[
			subminarm,
			yshift=-\subyshift,
		] (ema) at (zbnw) {\includegraphics[height=100pt]{logos/État_Major_des_armées.jpg} État-Major des armées};

		%---------------------------------
		% Service de santé des armées
		\node[
			subminarm
		] (sersantearmees) at (ema.north east) {\includegraphics[height=100pt]{logos/Servicedesantedesarmees.jpg} Service de santé des armées};
