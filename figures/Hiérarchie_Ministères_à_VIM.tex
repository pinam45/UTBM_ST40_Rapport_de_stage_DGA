...
\begin{document}
	...
	\begin{tikzpicture}[x=1pt,y=1pt]
		...
		] (mincult) at (minfr.north west) {\includegraphics[height=100pt]{logos/Ministère_de_la_Culture} Ministère de la culture};
		...
		\node[
			ministere,
			fill=zonebcolor,
		] (minarm) at (mincult.north east) {\includegraphics[height=100pt]{logos/MinisteredesArmees} \bfseries Ministère des armées};

		%---------------------------------
		% Ministère de l'économie et des finances
		\node[
			ministere
		] (minecofin) at (minarm.north east) {\includegraphics[height=100pt]{logos/Ministère_de_Économie_et_des_Finances} Ministère de l'économie et des finances};

		%---------------------------------
		% Ministère de l'Éducation nationale
		\node[
			ministere
		] (minedu) at (minecofin.north east) {\includegraphics[height=100pt]{logos/Ministère_de_Éducation_nationale} Ministère de l'Éducation nationale};
		...
		\node[
			subminarm,
			yshift=-\subyshift,
		] (ema) at (zbnw) {\includegraphics[height=100pt]{logos/État_Major_des_armées} État-Major des armées};

		%---------------------------------
		% Service de santé des armées
		\node[
			subminarm
		] (sersantearmees) at (ema.north east) {\includegraphics[height=100pt]{logos/Service_de_santé_des_armées} Service de santé des armées};
