...
\begin{document}
	...
	\begin{tikzpicture}[x=1pt,y=1pt]
		...
		%---------------------------------
		% GUI -- GUI impl
		\draw[->,>=latex] (gui.east) to (guiimp1.west);
		\draw[->,>=latex] (gui.east) to (guiimpl2.west);
		...
		\draw[->,>=latex] (asmmodule.east) to (asmmoduleimpl2.west);
		\draw[->,>=latex] (asmmodule.east) to (asmmoduleimpl1.west);
		\draw[->,>=latex,dashed] (asmmodule.east) to (asmmoduleimpl3.west);
		...
		\draw[->,>=latex] (cmdmodule.east) to (cmdmoduleimpl1.west);
		\draw[->,>=latex] (cmdmodule.east) to (cmdmoduleimpl2.west);
		\draw[->,>=latex,dashed] (cmdmodule.east) to (cmdmoduleimpl3.west);
		...
		\draw[->,>=latex] (symmodule.east) to (symmoduleimpl2.west);
		\draw[->,>=latex] (symmodule.east) to (symmoduleimpl1.west);
		\draw[->,>=latex,dashed] (symmodule.east) to (symmoduleimpl3.west);
		...
		\draw[->,>=latex] (oshelpermodule.east) to (oshelpermoduleimpl1.west);
		\draw[->,>=latex] (oshelpermodule.east) to (oshelpermoduleimpl2.west);
		\draw[->,>=latex,dashed] (oshelpermodule.east) to (oshelpermoduleimpl3.west);
		...
		\draw[->,>=latex] (bpmodule.east) to (bpmoduleimpl2.west);
		\draw[->,>=latex] (bpmodule.east) to (bpmoduleimpl1.west);
		\draw[->,>=latex,dashed] (bpmodule.east) to (bpmoduleimpl3.west);
