...
\begin{document}
	...
	\begin{tikzpicture}[x=1pt,y=1pt,>=Latex]
		...
		\node[
			...
			inner sep=1
		] (img) at (stub.south west) {\phantom{\includegraphics[width=1\textwidth]{GenDbg_GUI_Qt_Vue_code_Instruction_ecriture_memoire}}};

		%\draw[->,thick,green] (i3) -- ($(img.north west)+(53,-13)$);
	\end{tikzpicture}
\end{document}
