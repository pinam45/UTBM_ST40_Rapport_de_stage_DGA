...
\begin{document}
	...
	\begin{tikzpicture}[x=1pt,y=1pt]
		...
		\draw[->,>=latex] (gui.east) to (consolegui.west);
		\draw[->,>=latex] (gui.east) to (qtgui.west);
		...
		\draw[->,>=latex] (asmmodule.east) to (asmmodulemips.west);
		\draw[->,>=latex] (asmmodule.east) to (asmmodulex86.west);
		\draw[->,>=latex] (asmmodule.east) to (asmmoduleppc.west);
		\draw[->,>=latex] (asmmodule.east) to (asmmoduleamd64.west);
		\draw[->,>=latex] (asmmodule.east) to (asmmodulearm.west);
		...
		\draw[color=green,Turned Square-] (asmmoduleppc.east) -| (D);
